...
<div id="welcome-page" class="min-h-screen flex flex-col items-center justify-center p-6">
  <div class="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
    <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo Kang Naryo" class="w-24 h-auto mx-auto mb-4">
  ...
  <header class="bg-white shadow-sm sticky top-0 z-10">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
      <div class="flex items-center">
        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo Kang Naryo" style="height: 50px;" class="mr-4">
      </div>
      <div class="flex items-center">
  ...
  <div class="container mx-auto px-4 py-8 max-w-2xl">
    <div class="bg-white rounded-lg shadow-lg p-8" id="invoice-content">
      <div class="flex justify-between items-start mb-8">
        <div>
          <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo Kang Naryo" class="w-16 h-auto mb-2">
...
function displayMenuItems(category) {
    ...
    menuData[category].forEach(item => {
        ...
        const imageUrl = `<?php echo e(Storage::url('/')); ?>${item.image}`;
...
<?php /**PATH C:\xampp\htdocs\MPTI-Tugas Akhir\resources\views/pesanan.blade.php ENDPATH**/ ?>